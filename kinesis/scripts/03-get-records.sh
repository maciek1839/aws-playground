SHARD_ITERATOR=$(aws kinesis get-shard-iterator --region eu-central-1 --endpoint-url http://localhost:4566 --stream-name aws-playground-stream-1 --shard-id shardId-000000000000 --shard-iterator-type TRIM_HORIZON  | jq -r '.ShardIterator')
